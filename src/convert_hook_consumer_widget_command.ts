...
export const convertHookConsumerWidgetCommandName = "extension.convert-hook-consumer-widget";

export function convertHookConsumerWidgetCommandHandler(document: vscode.TextDocument, range: vscode.Range) {
  ...
  insertImportStatement(edit, document, documentTextArray, "import 'package:hooks_riverpod/hooks_riverpod.dart';");
