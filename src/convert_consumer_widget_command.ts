...
export function convertConsumerWidgetCommandHandler(document: vscode.TextDocument, range: vscode.Range) {
  ...
  insertImportStatement(edit, document, documentTextArray, "import 'package:flutter_riverpod/flutter_riverpod.dart';");
